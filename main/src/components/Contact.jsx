...
const Contact = () => {
  ...
  const formClasses = theme === 'dark' ? 'bg-gray-800' : 'bg-white';
  ...
  return (
    <section id="contact" className={`min-h-screen flex items-center justify-center p-4 sm:p-8 pt-24 ${sectionClasses}`}>
