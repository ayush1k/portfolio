...
class ChatResponse(BaseModel):
    ...
    suggestions: list[str] = Field(
        default_factory=list, description="Follow-up suggested questions generated by the AI model."
    )
...
def chat(request: ChatRequest):
    ...
    Pipeline:
      ...
      4. Return Qwen's grounded, context-constrained answer + follow-up suggestions.
    """
    ...
    # --- Step 2: Generate a grounded answer + suggestions using Qwen ---
    try:
